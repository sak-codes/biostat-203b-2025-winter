...
```{bash, eval=False}
zcat ~/mimic/hosp/labevents.csv.gz | awk -F, 'BEGIN {OFS=","} $0 ~ /(50912|50971|50983|50902|50882|51221|51301|50931)/ {print $1, $2, $4, $6}' | gzip > labevents_filtered.csv.gz
...
```{r}
gunzip <  ~/mimic/hosp/labevents.csv.gz
