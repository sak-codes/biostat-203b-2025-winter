...
- Q3 (??/20)
	...
	**Q3.4: Please interpret the output. (The output is a list of all the compressed (.gz) files in ~/mimic/hosp/ with starting letters a, l, or pa, displayed in a long format.)** (-1 pt)
